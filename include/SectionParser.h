...
private:
    ...
    const QMap<SectionType,
        std::function<std::variant<AbstractSection1::LinesType,
            AbstractSection2::LinesType>()>>
        parsers = {
            {SectionType::CODE_BLOCK,
                std::bind(&SectionParser::parseCodeBlock, this)},
            {SectionType::INDENTED_CODE_BLOCK,
                std::bind(&SectionParser::parseIndentedCodeBlock, this)},
            {SectionType::HORIZONTAL_RULE,
                [this]() {
                    return this->parseSingleLine(SectionType::HORIZONTAL_RULE);
                }},
            {SectionType::HTML,
                std::bind(&SectionParser::parseHtmlBlock, this)},
            {SectionType::ORDERED_LIST,
                [this]() {
                    return this->parseList(SectionType::ORDERED_LIST);
                }},
            ...
            {SectionType::TITLE,
                [this]() { return this->parseSingleLine(SectionType::TITLE); }},
            {SectionType::UNORDERED_LIST,
                [this]() {
                    return this->parseList(SectionType::UNORDERED_LIST);
                }},
    };
