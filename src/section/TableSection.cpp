...
QString TableSection::toHtml() {
    static const auto min = [](qsizetype a, qsizetype b) {
        return a < b ? a : b;
    };
    static const auto max = [](qsizetype a, qsizetype b) {
        return a > b ? a : b;
    };
    static const QMap<Align, QString> align_map = {{Align::LEFT, "left"},
        {Align::CENTER, "center"}, {Align::RIGHT, "right"}};
...
QString TableSection::before() { return QString("<table>"); }

QString TableSection::after() { return QString("</table>"); }
