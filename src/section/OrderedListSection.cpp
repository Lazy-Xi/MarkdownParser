...
OrderedListSection &OrderedListSection::operator=(
    const OrderedListSection &other) {
    if (this != &other) {
...
OrderedListSection &OrderedListSection::operator=(
    OrderedListSection &&other) noexcept {
    if (this != &other) {
...
QString OrderedListSection::toHtml() {
    ...
    for (auto &i : lines) {
        if (std::holds_alternative<QString>(i)) {
            ...
            const QString &text = RegexUtils::orderedList(true)
...
QString OrderedListSection::before() { return QString("<ol>"); }

QString OrderedListSection::after() { return QString("</ol>"); }