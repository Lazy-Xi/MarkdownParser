...
static const QMap<SectionType, std::function<bool(const QString &)>>
    checks = {
        {SectionType::HTML, TypeUtils::isHtmlBlock},
        {SectionType::INDENTED_CODE_BLOCK,
            TypeUtils::isIndentedCodeBlock},
