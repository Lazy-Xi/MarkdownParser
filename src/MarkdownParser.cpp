...
const QString MarkdownParser::default_style_sheet =
    __default_style_sheet;
...
// Walk the AST to find the first level-1 heading and return its inner
// HTML.
